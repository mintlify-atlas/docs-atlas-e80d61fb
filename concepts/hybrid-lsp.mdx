---
title: "Hybrid LSP: Semantic Type Resolution Without a Language Server"
sidebarTitle: "Hybrid LSP"
description: "Hybrid LSP resolves types, generics, and inheritance across files inside the static binary — no language server process, no per-project setup, no API keys."
---
...
<Note>
All eleven languages are available out of the box — no additional downloads, no language server processes, no configuration. Hybrid LSP is compiled into the binary.
</Note>
