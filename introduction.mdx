...
description: "Codebase Memory MCP indexes any codebase into a persistent knowledge graph. 158 languages, sub-ms queries, 99.2% fewer tokens, single static binary."
---
