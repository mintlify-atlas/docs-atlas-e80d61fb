...
<CardGroup cols={2}>
  ...
  <Card title="Never" icon="ban">
    Makes outbound network requests during normal indexing or query operation. The update check is the only background request and is opt-out via not running `update`.
  </Card>
</CardGroup>
