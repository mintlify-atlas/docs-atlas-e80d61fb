...
description: "All installation methods for Codebase Memory MCP: one-line installer, Homebrew, AUR, npm, PyPI, Scoop, Winget, Chocolatey, go install, and build from source."
---
...
<CardGroup cols={2}>
  ...
  <Card title="PyPI (uv)" icon="python">
